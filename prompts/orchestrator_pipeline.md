...
1. Aplica el protocolo de destino:
   `<MOTOR_ROOT>/prompts/orchestrator_destination_bootstrap.md`.
...
| Review 1 | MANAGER | `<MOTOR_ROOT>/prompts/manager_review.md`, `<MOTOR_ROOT>/prompts/audit_agent_output.md` | `<MOTOR_ROOT>/skills/manager-review-implementation/SKILL.md` | `git show`, `git status`, tests focales, `python <MOTOR_ROOT>/.agent/agent_controller.py --validate --json --project-root .` |
| Review 2 | MANAGER adversarial | `<MOTOR_ROOT>/prompts/manager_review.md`, `<MOTOR_ROOT>/prompts/audit_agent_output.md` | `<MOTOR_ROOT>/skills/manager-review-implementation/SKILL.md`, `<MOTOR_ROOT>/skills/builder-self-audit/SKILL.md` como input critico | buscar counterexamples en diff real, bus, scope y gates |
...
- `<MOTOR_ROOT>/prompts/orchestrator_launch_builder.md`
- `<MOTOR_ROOT>/skills/builder-implement-from-plan/SKILL.md`
- `<MOTOR_ROOT>/skills/builder-self-audit/SKILL.md`
...
- `<MOTOR_ROOT>/prompts/manager_review.md`
- `<MOTOR_ROOT>/prompts/audit_agent_output.md`
- `<MOTOR_ROOT>/skills/manager-review-implementation/SKILL.md`
- `DESTINO_ROOT/.agent/collaboration/work_plan.md`
- `DESTINO_ROOT/.agent/collaboration/PLAN_{TICKET_ID}.md`
- `DESTINO_ROOT/.agent/collaboration/AUDIT_{TICKET_ID}.md`
- `DESTINO_ROOT/.agent/collaboration/execution_log.md`
...
- inyecta tambien `<MOTOR_ROOT>/skills/builder-self-audit/SKILL.md`;
...
2. Aplicar el protocolo canonico de cierre de chat:
   `<MOTOR_ROOT>/prompts/orchestrator_session_close_chat.md`.
