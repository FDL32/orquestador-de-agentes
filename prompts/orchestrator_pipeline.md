...
| Review 2 | MANAGER adversarial | `<MOTOR_ROOT>/prompts/manager_review.md`, `<MOTOR_ROOT>/prompts/audit_agent_output.md` | `<MOTOR_ROOT>/skills/manager-review-implementation/SKILL.md`, `<MOTOR_ROOT>/skills/bui-self-audit/SKILL.md` como input critico | buscar counterexamples en diff real, bus, scope y gates |
