...
from scripts.compress_canonical import (
    ...
    _mark_preserved_segments,
    _restore_preserved_segments,
)
...
class TestBackup:
    ...
    def test_backup_preserves_encoding(self, tmp_path: Path):
        ...
        assert backup_path.read_text(encoding='utf-8') == "Content with unicode: 你好世界 🌍"
...
class TestProcessFile:
    ...
    def test_process_with_backup(self, tmp_path: Path):
        ...
        success, message, change_count = process_file(file_path, backup=True)
