...
class TestDeriveProjectSlug:
    ...
    def test_windows_path(self):
        ...
        root = Path("C:/Users/***REDACTED***/Proyectos_Python/z_scripts")
        slug = derive_project_slug(root)
        assert slug == "c--Users-***REDACTED***-Proyectos-Python-z-scripts"
...
class TestRealPathSlug:
    ...
    def test_workspace_slug(self):
        ...
        workspace = Path("C:/Users/***REDACTED***/Proyectos_Python/z_scripts")
