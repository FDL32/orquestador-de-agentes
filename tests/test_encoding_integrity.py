...
FILES_TO_CHECK = [
    ...
    ROOT / "skills" / "refactor-manager" / "SKILL.md",
    ROOT / "skills" / "man-create-work-plan" / "SKILL.md",
    ROOT / "skills" / "code-audit" / "SKILL.md",
    ROOT / "skills" / "man-resolve-escalation" / "SKILL.md",
    ROOT / "skills" / "code-audit" / "references" / "audit-tools-guide.md",
    ROOT / "skills" / "man-create-work-plan" / "references" / "plan-template.md",
    ROOT / "skills" / "man-create-work-plan" / "references" / "risk-guide.md",
    ROOT / "skills" / "man-resolve-escalation" / "references" / "escalation-levels.md",
