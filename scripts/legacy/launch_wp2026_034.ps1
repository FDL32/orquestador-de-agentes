...
$root = "C:\Users\***REDACTED***\Proyectos_Python\z_scripts\orquestacion_agentes"
$codexExe = "C:\Users\***REDACTED***\.vscode\extensions\openai.chatgpt-26.506.31421-win32-x64\bin\windows-x86_64\codex.exe"
$kiloExe = "C:\Users\***REDACTED***\.vscode\extensions\kilocode.kilo-code-7.2.52-win32-x64\bin\kilo.exe"
