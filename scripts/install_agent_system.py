...
INSTALLER_BOOTSTRAP_PATHS: frozenset[str] = frozenset(
    {
        ...
        # Generated by destination_context.py --bootstrap (destination_bootstrap.md
        # step 4 reads it). Pruning it on sync breaks the destination bootstrap
        # contract: the next session would find no map.
        "context/destination_map.md",
    }
)
